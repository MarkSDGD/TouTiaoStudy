...
import com.sdgd.news.model.entity.NewsRecord;
import com.sdgd.news.model.event.DetailCloseEvent;
import com.sdgd.news.model.event.TabRefreshCompletedEvent;
import com.sdgd.news.model.event.TabRefreshEvent;
import com.sdgd.news.ui.activity.NewsDetailBaseActivity;
import com.sdgd.news.ui.activity.NewsDetailDetailActivity;
import com.sdgd.news.ui.activity.VideoDetailActivity;
import com.sdgd.news.ui.activity.WebViewActivity;
import com.sdgd.news.ui.adapter.NewsAdapter;
import com.sdgd.news.ui.base.BaseFragment;
import com.sdgd.news.ui.presenter.NewsListPresenter;
import com.sdgd.news.utils.ListUtils;
import com.sdgd.news.utils.NetWorkUtils;
import com.sdgd.news.utils.NewsRecordHelper;
...
public class NewsListFragment extends BaseFragment<NewsListPresenter> implements lNewsListView, BGARefreshLayout.BGARefreshLayoutDelegate, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    @Bind(com.sdgd.news.R.id.tip_view)
    TipView mTipView;

    @Bind(com.sdgd.news.R.id.refresh_layout)
    BGARefreshLayout mRefreshLayout;

    @Bind(com.sdgd.news.R.id.fl_content)
    FrameLayout mFrameLayout;

    @Bind(com.sdgd.news.R.id.rv_news)
    ...
    protected int provideContentViewId() {
        ...
        return com.sdgd.news.R.layout.fragment_news_list;
    }
    ...
    public void initView(View rootView) {
        ...
        // 设置下拉刷新
        refreshViewHolder.setRefreshViewBackgroundColorRes(com.sdgd.news.R.color.pull_refresh_bg);//背景色
        refreshViewHolder.setPullDownRefreshText(UIUtils.getString(com.sdgd.news.R.string.refresh_pull_down_text));//下拉的提示文字
        refreshViewHolder.setReleaseRefreshText(UIUtils.getString(com.sdgd.news.R.string.refresh_release_text));//松开的提示文字
        refreshViewHolder.setRefreshingText(UIUtils.getString(com.sdgd.news.R.string.refresh_ing_text));//刷新中的提示文字
    ...
    public void onGetNewsListSuccess(List<News> newList, String tipInfo) {
        ...
        if (ListUtils.isEmpty(newList)) {
            ...
            UIUtils.showToast(UIUtils.getString(com.sdgd.news.R.string.no_news_now));
            return;
        }
    ...
    public void onRefreshEvent(TabRefreshEvent event) {
        ...
        if (event.getChannelCode().equals(mChannelCode) && mRefreshLayout.getCurrentRefreshStatus() != BGARefreshLayout.RefreshStatus.REFRESHING) {
            ...
            if (event.isHomeTab()) {
                ...
                bottomBarItem.setIconSelectedResourceId(com.sdgd.news.R.mipmap.tab_loading);//更换成加载图标

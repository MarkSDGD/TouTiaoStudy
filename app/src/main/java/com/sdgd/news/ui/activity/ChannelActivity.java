...
import com.sdgd.news.listener.ItemDragHelperCallBack;
...
import com.sdgd.news.ui.adapter.ChannelAdapter;
import com.sdgd.news.ui.base.BaseActivity;
import com.sdgd.news.ui.base.BasePresenter;
import com.sdgd.news.utils.ConstanceValue;
...
public class ChannelActivity extends BaseActivity implements OnChannelDragListener {
    ...
    @Bind(com.sdgd.news.R.id.recyclerView)
   ...
   // private final String[] titles = new String[]{"推荐", "视频", "热点", "社会", "娱乐", "科技", "汽车", "体育", "财经", "军事", "国际", "时尚", "游戏", "旅游", "历史", "探索", "美食", "育儿", "养生", "故事", "美文"};
    ...
    protected int provideContentViewId() {
        ...
        return com.sdgd.news.R.layout.activity_channel;
    }

    @OnClick(com.sdgd.news.R.id.icon_collapse)

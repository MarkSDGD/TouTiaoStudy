...
import com.sdgd.news.model.entity.CommentData;
import com.sdgd.news.model.event.DetailCloseEvent;
import com.sdgd.news.model.response.CommentResponse;
import com.sdgd.news.ui.adapter.CommentAdapter;
import com.sdgd.news.ui.base.BaseActivity;
import com.sdgd.news.ui.presenter.NewsDetailPresenter;
import com.sdgd.news.ui.view.NewsDetailHeaderView;
...
public abstract class NewsDetailBaseActivity extends BaseActivity<NewsDetailPresenter> implements INewsDetailView, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    @Bind(com.sdgd.news.R.id.rv_comment)
    PowerfulRecyclerView mRvComment;

    @Bind(com.sdgd.news.R.id.tv_comment_count)
    ...
    public void initView() {
        ...
        mStateView.setLoadingResource(com.sdgd.news.R.layout.page_loading);
        mStateView.setRetryResource(com.sdgd.news.R.layout.page_net_error);
    }
    ...
    public void initListener() {
        mCommentAdapter = new CommentAdapter(this, com.sdgd.news.R.layout.item_comment, mCommentList);
        ...
        mCommentAdapter.setEmptyView(com.sdgd.news.R.layout.pager_no_comment);
    ...
    @OnClick({com.sdgd.news.R.id.fl_comment_icon})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case com.sdgd.news.R.id.fl_comment_icon:
                //底部评论的图标

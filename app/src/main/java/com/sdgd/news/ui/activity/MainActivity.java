...
import com.sdgd.news.ui.adapter.MainTabAdapter;
...
import com.sdgd.news.ui.fragment.HomeFragment;
import com.sdgd.news.ui.fragment.MicroFragment;
import com.sdgd.news.ui.fragment.MineFragment;
import com.sdgd.news.ui.fragment.VideoFragment;
...
public class MainActivity extends BaseActivity {
    ...
    @Bind(com.sdgd.news.R.id.bottom_bar)
    ...
    private int[] mStatusColors = new int[]{
            com.sdgd.news.R.color.status_color_red,
            com.sdgd.news.R.color.status_color_grey,
            com.sdgd.news.R.color.status_color_grey,
    };
    ...
    protected int provideContentViewId() {
        return com.sdgd.news.R.layout.activity_main;
    }
    ...
    public void initListener() {
        ...
        mBottomBarLayout.setOnItemSelectedListener(new BottomBarLayout.OnItemSelectedListener() {
            ...
            public void onItemSelected(BottomBarItem bottomBarItem, int position) {
                ...
                bottomItem.setIconSelectedResourceId(com.sdgd.news.R.mipmap.tab_home_selected);//更换为原来的图标
    ...
    public void onRefreshCompletedEvent(TabRefreshCompletedEvent event) {
        ...
        bottomItem.setIconSelectedResourceId(com.sdgd.news.R.mipmap.tab_home_selected);//更换成首页原来图标

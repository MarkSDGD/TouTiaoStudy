...
public class BigImageFragment extends BaseFragment {
    ...
    @Bind(com.sdgd.news.R.id.pv_pic)
    PhotoView mIvPic;

    @Bind(com.sdgd.news.R.id.progressView)
    ...
    protected int provideContentViewId() {
        return com.sdgd.news.R.layout.fragment_big_image;
    }
    ...
    protected void loadData() {
        ...
        imageLoader.setOnGlideImageViewListener(imgUrl, new OnGlideImageViewListener() {
            ...
            public void onProgress(int percent, boolean isDone, GlideException exception) {
                if (exception != null && !TextUtils.isEmpty(exception.getMessage())) {
                    UIUtils.showToast(getString(com.sdgd.news.R.string.net_error));
                }
        ...
        RequestOptions options = imageLoader.requestOptions(com.sdgd.news.R.color.placeholder_color)
                .centerCrop()
